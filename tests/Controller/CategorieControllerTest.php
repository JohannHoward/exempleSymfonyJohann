...
class CategorieControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'categorie[Duree]' => 'Testing',
            'categorie[NombreChaine]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setNombreChaine('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'categorie[Duree]' => 'Something New',
            'categorie[NombreChaine]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getNombreChaine());
    }
